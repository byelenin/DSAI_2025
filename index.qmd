...
::: callout-important
**\[2025/09/11\]** I will introduce Basic R and Data manage skills using Rmarkdown. And in the lab session, our TA, Xiaotian will continue to work git and GitHub, which are essential tools for version control and collaboration in data science projects. [**Please make sure to bring your laptops to class!**]{style="color: red;"}
:::
